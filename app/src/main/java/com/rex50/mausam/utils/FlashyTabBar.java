...
public class FlashyTabBar extends ViewPager.SimpleOnPageChangeListener {
    ...
    public FlashyTabBar(TabLayout tabLayout) {
    ...
    private void getTabView(int position, TabLayout.Tab tab, boolean isSelected) {
        ...
        if(isSelected) {
            ...
            dot.startAnimation(AnimationUtils.loadAnimation(tabLayout.getContext(), R.anim.tab_show));
        } else {
            ...
            if(position == previousPosition || previousPosition == -1) {
                dot.startAnimation(AnimationUtils.loadAnimation(tabLayout.getContext(), R.anim.tab_hide));
            }
        }
