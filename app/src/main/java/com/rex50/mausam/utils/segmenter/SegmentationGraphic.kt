...
package com.rex50.mausam.utils.segmenter
...
class SegmentationGraphic(overlay: GraphicOverlay, segmentationMask: SegmentationMask, private val blurredBitmap: Bitmap? = null) :
  ...
  private fun maskColorsFromByteBuffer(byteBuffer: ByteBuffer): IntArray {
    ...
    //TODO: Can use blurred bitmap byteBuffer for overlay
