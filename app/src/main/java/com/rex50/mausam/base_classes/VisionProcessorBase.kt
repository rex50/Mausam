...
import com.rex50.mausam.utils.ScopedExecutor
import com.rex50.mausam.utils.segmenter.CameraImageGraphic
import com.rex50.mausam.utils.segmenter.FrameMetadata
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
  ...
  private fun processImage(
    ...
    val bitmap = BitmapUtils.getBitmap(data, frameMetadata)
      /*TODO: if (PreferenceUtils.isCameraLiveViewportEnabled(graphicOverlay.context)) null
    ...
    return task
      .addOnSuccessListener(
        ...
        OnSuccessListener { results: T ->
          ...
          /*TODO: if (!PreferenceUtils.shouldHideDetectionInfo(graphicOverlay.context)) {
            graphicOverlay.add(
