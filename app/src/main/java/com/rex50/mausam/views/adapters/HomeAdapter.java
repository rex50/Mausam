...
import static com.rex50.mausam.utils.Constants.RecyclerItemTypes.FAVOURITE_PHOTOGRAPHER_PHOTOS_TYPE;
...
public class HomeAdapter extends RecyclerView.Adapter{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case FAVOURITE_PHOTOGRAPHER_PHOTOS_TYPE :
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        } else if(viewType == FAVOURITE_PHOTOGRAPHER_PHOTOS_TYPE){
            ItemCategoryHolder itemHolder = ((ItemCategoryHolder) holder);
            GenericModelFactory model = allContentModel.getModel(position);
            itemHolder.txtTitle.setText(model.getTitle());
            itemHolder.txtDesc.setText(model.getDesc());
